...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 28rem;">
                    <img src="https://res.cloudinary.com/cmpe272img/image/upload/v1621802415/webpageImage/HikeLife_d20qad.png" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Hike Life</h5>
            ...
            <div class="col">
                <div class="card" style="width: 28rem;">
                    <img src="https://res.cloudinary.com/cmpe272img/image/upload/v1621802415/webpageImage/Skyvah_ywqhi2.png" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Skyvah</h5>
        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 28rem;">
                    <img src="https://res.cloudinary.com/cmpe272img/image/upload/v1621802416/webpageImage/Omnifood_roebza.png" class="card-img-top">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card" style="width: 28rem;">
                    <img src="https://res.cloudinary.com/cmpe272img/image/upload/v1621802414/webpageImage/Homedecor_plgxor.png" class="card-img-top">
                    <div class="card-body">
